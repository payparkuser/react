...
// Fifth layout pages
import bookingsViewChat from "./components/User/BookingsManagement/bookingsViewChat";
...
import Photo from "./components/User/Account/photo";
import Notification from "./components/User/Account/userNotification";
...
import UserReview from "./components/User/Account/userReview";
...
import TripHistory from "./components/User/BookingsManagement/bookingsHistory";
import BookingsView from "./components/User/BookingsManagement/bookingsView";
...
import HostBookingManagement from "./components/Host/Bookings/bookingManagement";
...
import Inbox from "./components/User/BookingsManagement/inbox";
...
import Vehicle from "./components/User/Account/vehicle";
        ...
        <div>
          <div className="wrapper">
            <div className="loader-warpper">
              <div id="loader">
                <ul>
                  <li>Parking spaces configuration Loading....</li>
                </ul>
              </div>
            </div>
          </div>
