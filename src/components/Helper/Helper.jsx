...
class Helper extends Component {
    ...
    priceCalculatorApiCall(inputData) {
        api.postMethod("spaces_price_calculator", inputData).then(response => {
    ...
    /**
     *
     * @summary used to check the user/provider is able access further
     *
     * @param integer error_code
     */

    checkLoginStatus(error_code, is_user = 1) {
        console.log("* * * * * * * * * * * * * * * * * *");

        console.log(error_code, is_user);
        ...
        if (
            ...
            if (is_user == 1) {
                ...
                localStorage.setItem("providerLoginStatus", false);
