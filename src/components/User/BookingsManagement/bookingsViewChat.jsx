...
let socket, host_details, provider_details, pricing_details, page;

class bookingsViewChat extends Helper {
    state = {
        message: null,
        data: null,
        chatList: null,
    ...
    chatDetailsApiCall = () => {
        ...
        if (host_details.booking_id === undefined) {
            inputData = {
                space_id: host_details.space_id,
                ...
                if (this.state.loadMoreChatHistory) {
                    ...
                    this.setState({
                        ...
                        chatHistorySkipCount:
                            ...
                            this.state.chatHistorySkipCount,
                        loadingStatusChatHistory: true,
                        loadMoreChatHistory: false
                    });
                } else {
        ...
        return (
            <div className="main">
                {loading ? (
                  ...
                  <h4 className="captalize m-0">{host_details.space_name}</h4>
                </div> */}
                                <div className="chat-header">
...
export default translate(bookingsViewChat);
