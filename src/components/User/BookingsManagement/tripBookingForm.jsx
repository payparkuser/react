...
class TripBookingForm extends Helper {
  ...
  componentDidMount() {
    this.setState({
      space_id: this.props.basicDetails.space_id,
    ...
    return (
      <div className="col-xl-5 pl-5 relative dis-lg-none dis-md-none dis-sm-none dis-xs-none">
        <div className="pricedetails-box">
          ...
          <div className="form-group">
            <label className="medium-cls">{t("guests")}</label>
            <input
              type="text"
              id="guest-mobile-btn"
          ...
          <h5 className="small-text">{t("booking_form_para1")}</h5>
          <p className="overview-line" />
          <div className="media top1">
            <div className="media-body">
              <h4 className="home-info">{t("booking_form_para2")}</h4>
              <p className="home-info-text">
                {t("booking_form_para3")}
              </p>
            </div>
            <img
