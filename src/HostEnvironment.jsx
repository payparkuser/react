...
const apiUrl = "https://admin-rentpark.rentcubo.info/api/provider/"; // Production Mode

// const apiUrl = "http://adminpark-staging.streamtunes.info/api/provider/"; // Developement Mode
...
const HostEnvironment = {
    ...
    newMethod(action, object) {
        ...
        const url =
            "http://adminpark-staging.streamtunes.info/default-json/settings.json";
